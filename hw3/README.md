...
This assignment has you fetching data from `https://cs571.org/rest/s25/hw3/featured-item`, which changes on a daily basis. To see how your code reacts to any given day's feature, you can specify an optional query parameter of 'day', e.g. `https://cs571.org/rest/s25/hw3/featured-item?day=Friday`. This is simply for your testing purposes.
...
In `BadgerMart.jsx`, fetch today's featured item from `https://cs571.org/rest/s25/hw3/featured-item` and save it to the `feature` state variable via its mutator function. **As a part of your fetch, `console.log` the response body data that you receive.**
